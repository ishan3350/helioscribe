...
const getPasswordResetEmailTemplate = (firstName, resetCode) => {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Reset Your Password - HelioScribe</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <div class="greeting">Hello ${firstName},</div>
            <div class="message">
                We received a request to reset your password for your HelioScribe account. 
            ...
            <div class="security-notice">
                <strong>Security Notice:</strong> For your security, this code will expire in 15 minutes. 
                Never share your reset code with anyone. If you didn't request a password reset, 
